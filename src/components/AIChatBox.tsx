    ...
    return <div className={cn("bottom-0 right-0 z-10 w-full max-w-[500px] p-1 xl:right-36", open ? "fixed" : "hidden") }>
        ...
        <div className="flex h-[600px] flex-col rounded bg-background border shadow-xl">
            ...
            {isLoading && lastMessageIsUser && (
                <ChatMessage message={{ role: "assistant", content: "Wizard is thinking..." }} />
            )}
            ...
            { error && (
                ...
                { !error && messages.length   == 0 && (
                    <div className="flex h-full items-center justify-center gap-3">
                        <Bot />
                        Ask Wizard a question about your notes
            ...
            className="m-3 flex gap-1">
                ...
                <Button title="Clear Chat" variant="outline" size="icon" className="shrink-0" type="button" onClick={() => setMessages([])}>
                    <Trash />
                </Button>

                <Input value={input} onChange={handleInputChange} placeholder="Type your message here..." ref={inputRef}  />
